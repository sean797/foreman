module HostsHelper
  ...
  def multiple_actions
    ...
    if authorized_for(:controller => :hosts, :action => :edit)
      ...
      actions <<  [_('Change Puppet Master SmartProxyPool'), select_multiple_puppet_proxy_hostname_hosts_path] if SmartProxy.unscoped.authorized.with_features("Puppet").exists?
      actions <<  [_('Change Puppet CA SmartProxyPool'), select_multiple_puppet_ca_proxy_hostname_hosts_path] if SmartProxy.unscoped.authorized.with_features("Puppet CA").exists?
    end
